...
| :--- | :--- | :--- | :--- |
| **TC-01: Question Pool Integrity** | Bank size >= 250 with strictly unique IDs | 290 Questions | **PASSED** |
...
| **TC-05: Early-Failure Trigger Logic** | 6 wrong answers mathematically triggers early failure | Boundary Values | **PASSED** |
| **TC-06: Category Breakdown Summation** | Category percentages and counts sum to 30 | Random Sample | **PASSED** |
| **TC-07: Asset Existence Audit** | All 34 SVG signs and 12 scenario images exist on disk | 100% Asset Paths | **PASSED** |
| **TC-08: Arabic Bank 1-to-1 Mapping** | Arabic questions match English question IDs and choices | 290 Questions | **PASSED** |
...
- **Practice Mode**: Verified immediate answer feedback (green for correct, red for wrong) with instant display of the Alberta Driver's Guide explanation.
- **Smart Weakness Review**: Verified that questions are weighted heavily (~70%) toward categories with user accuracy < 75%.
- **Road Sign Challenge**: Verified that questions exclusively test regulatory, warning, and information signs.
